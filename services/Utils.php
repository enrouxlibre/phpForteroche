...
class Utils
{
    ...
    /**
     * Trie un tableau d'articles selon un critère et un ordre donné.
     * @param array $articles : la liste des articles à trier.
     * @param string $sortBy : le champ de tri ('title', 'views', 'comments', 'date_creation').
     * @param bool $ascending : true pour un tri ascendant, false pour un tri descendant.
     * @return array : la liste des articles triée.
     */
    public static function sortArticles(array $articles, string $sortBy, bool $ascending = true): array
    {
